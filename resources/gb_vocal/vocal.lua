...
--			NetworkSetTalkerProximity(portevoix)
			Texte("Voice range set to normal (~g~".. portevoix .."~s~m)", 5000)
		  elseif portevoix == 10.0 then
		    portevoix = 26.0
--			NetworkSetTalkerProximity(portevoix)
			Texte("Voice range set to yell (~g~".. portevoix .."~s~m)", 5000)
		  elseif portevoix >= 26.0 then
		    portevoix = 2.0
--			NetworkSetTalkerProximity(portevoix)
			Texte("Voice range set to whisper (~g~".. portevoix .."~s~m)", 5000)
		  end
		  NetworkSetTalkerProximity(portevoix)
		end
