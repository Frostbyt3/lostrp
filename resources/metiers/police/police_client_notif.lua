...
--function POLICE_RepairEngine()
--	Citizen.CreateThread(function()
--		Citizen.Trace('POLICE_RepairEngine')
--		local ply = GetPlayerPed(-1)
--		local plyCoords = GetEntityCoords(ply, 0)
--		veh = GetClosestVehicle(plyCoords["x"], plyCoords["y"], plyCoords["z"], 5.001, 0, 70)
--		if veh ~= 0 then
...
--			if vehHP >= 0 then
--				SetVehicleEngineHealth(veh, 960.0)
--				SetVehicleEngineOn(veh, 0, 0, 0)
--				SetVehicleUndrivable(veh, false)
--				SetVehicleEngineTorqueMultiplier(veh, 1.0)
--				TriggerEvent('chatMessage', 'SYSTEM' {255, 0, 0}, "Engine Repaired")
--			else
--				TriggerEvent('chatMessage', 'SYSTEM' {255, 0, 0}, "Unable to Repair")
--			end
--		else
--			TriggerEvent('chatMessage', 'SYSTEM' {255, 0, 0}, "You must be in front of the vehicle")
--	end)
--end
--====================================================================================
-- Event 
