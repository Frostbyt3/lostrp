...
function MainMenu()
    ClearMenu()
    Menu.addButton("Create your Skin", "modelMenu", nil, nil)
end
...
-------- MODEL MENU -------
function modelMenu()
    options.menu_subtitle = "Gender Selection"
    ClearMenu()
...
--------- SHAPE ------------
function shapeMenu()
    options.menu_subtitle = "Face"
    ClearMenu()
    Menu.addButton("Return", "modelMenu", nil, nil)
    if current_skin.model == 'mp_f_freemode_01' then
        Menu.addButton("Face n°1", "setShapeEnter", 21, "setShape")
        Menu.addButton("Face n°2", "setShapeEnter", 22, "setShape")
        Menu.addButton("Face n°3", "setShapeEnter", 23, "setShape")
        Menu.addButton("Face n°4", "setShapeEnter", 24, "setShape")
        Menu.addButton("Face n°5", "setShapeEnter", 25, "setShape")
        Menu.addButton("Face n°6", "setShapeEnter", 26, "setShape")
        Menu.addButton("Face n°7", "setShapeEnter", 27, "setShape")
        Menu.addButton("Face n°8", "setShapeEnter", 28, "setShape")
        Menu.addButton("Face n°9", "setShapeEnter", 29, "setShape")
        Menu.addButton("Face n°11", "setShapeEnter", 31, "setShape")
        Menu.addButton("Face n°12", "setShapeEnter", 32, "setShape")
        Menu.addButton("Face n°13", "setShapeEnter", 33, "setShape")
        Menu.addButton("Face n°14", "setShapeEnter", 34, "setShape")
        Menu.addButton("Face n°15", "setShapeEnter", 35, "setShape")
        Menu.addButton("Face n°16", "setShapeEnter", 36, "setShape")
        Menu.addButton("Face n°17", "setShapeEnter", 37, "setShape")
        Menu.addButton("Face n°18", "setShapeEnter", 38, "setShape")
        Menu.addButton("Face n°19", "setShapeEnter", 39, "setShape")
        Menu.addButton("Face n°20", "setShapeEnter", 40, "setShape")
        Menu.addButton("Face n°21", "setShapeEnter", 41, "setShape")
        Menu.addButton("Face n°22", "setShapeEnter", 45, "setShape")
    else
        Menu.addButton("Face n°1", "setShapeEnter", 0, "setShape")
        Menu.addButton("Face n°2", "setShapeEnter", 1, "setShape")
        Menu.addButton("Face n°3", "setShapeEnter", 2, "setShape")
        Menu.addButton("Face n°4", "setShapeEnter", 3, "setShape")
        Menu.addButton("Face n°5", "setShapeEnter", 4, "setShape")
        Menu.addButton("Face n°6", "setShapeEnter", 5, "setShape")
        Menu.addButton("Face n°7", "setShapeEnter", 6, "setShape")
        Menu.addButton("Face n°8", "setShapeEnter", 7, "setShape")
        Menu.addButton("Face n°9", "setShapeEnter", 8, "setShape")
        Menu.addButton("Face n°10", "setShapeEnter", 9, "setShape")
        Menu.addButton("Face n°11", "setShapeEnter", 10, "setShape")
        Menu.addButton("Face n°12", "setShapeEnter", 11, "setShape")
        Menu.addButton("Face n°13", "setShapeEnter", 12, "setShape")
        Menu.addButton("Face n°14", "setShapeEnter", 13, "setShape")
        Menu.addButton("Face n°15", "setShapeEnter", 14, "setShape")
        Menu.addButton("Face n°16", "setShapeEnter", 15, "setShape")
        Menu.addButton("Face n°17", "setShapeEnter", 16, "setShape")
        Menu.addButton("Face n°18", "setShapeEnter", 17, "setShape")
        Menu.addButton("Face n°19", "setShapeEnter", 18, "setShape")
        Menu.addButton("Face n°20", "setShapeEnter", 19, "setShape")
        Menu.addButton("Face n°21", "setShapeEnter", 20, "setShape")
        Menu.addButton("Face n°22", "setShapeEnter", 42, "setShape")
        Menu.addButton("Face n°23", "setShapeEnter", 43, "setShape")
        Menu.addButton("Face n°24", "setShapeEnter", 44, "setShape")
    end
    Menu.addButton("Return", "modelMenu", nil, nil)
...
------- BODY COLOR ----------
function bodyColor()
    options.menu_subtitle = "Skin Color"
    ClearMenu()
    Menu.addButton("Return", "shapeMenu", nil, nil)
    Menu.addButton("Skin Color n°1", "setBodyColorEnter", 21, "setBodyColor")
    Menu.addButton("Skin Color n°2", "setBodyColorEnter", 22, "setBodyColor")
    Menu.addButton("Skin Color n°3", "setBodyColorEnter", 23, "setBodyColor")
    Menu.addButton("Skin Color n°4", "setBodyColorEnter", 24, "setBodyColor")
    Menu.addButton("Skin Color n°5", "setBodyColorEnter", 25, "setBodyColor")
    Menu.addButton("Skin Color n°6", "setBodyColorEnter", 26, "setBodyColor")
    Menu.addButton("Skin Color n°7", "setBodyColorEnter", 27, "setBodyColor")
    Menu.addButton("Skin Color n°8", "setBodyColorEnter", 28, "setBodyColor")
    Menu.addButton("Skin Color n°9", "setBodyColorEnter", 29, "setBodyColor")
    Menu.addButton("Skin Color n°11", "setBodyColorEnter", 31, "setBodyColor")
    Menu.addButton("Skin Color n°12", "setBodyColorEnter", 32, "setBodyColor")
    Menu.addButton("Skin Color n°13", "setBodyColorEnter", 33, "setBodyColor")
    Menu.addButton("Skin Color n°14", "setBodyColorEnter", 34, "setBodyColor")
    Menu.addButton("Skin Color n°15", "setBodyColorEnter", 35, "setBodyColor")
    Menu.addButton("Skin Color n°16", "setBodyColorEnter", 36, "setBodyColor")
    Menu.addButton("Skin Color n°17", "setBodyColorEnter", 37, "setBodyColor")
    Menu.addButton("Skin Color n°18", "setBodyColorEnter", 38, "setBodyColor")
    Menu.addButton("Skin Color n°19", "setBodyColorEnter", 39, "setBodyColor")
    Menu.addButton("Skin Color n°20", "setBodyColorEnter", 40, "setBodyColor")
    Menu.addButton("Skin Color n°21", "setBodyColorEnter", 41, "setBodyColor")
    Menu.addButton("Skin Color n°22", "setBodyColorEnter", 45, "setBodyColor")
    Menu.addButton("Return", "shapeMenu", nil, nil)
...
function eyebrowsMenu()
    options.menu_subtitle = "Eyebrows"
    ClearMenu()
    Menu.addButton("Return", "bodyColor", nil, nil)
    for i = 0, GetNumHeadOverlayValues(1) do
        Menu.addButton("Eyebrows n°"..i, "eyebrowsSelectorMenuEnter", i, "eyebrowsSelectorMenu")
    end
    Menu.addButton("Return", "bodyColor", nil, nil)
end
...
function eyebrowsColorMenu()
    options.menu_subtitle = "Eyebrow Color"
    ClearMenu()
    Menu.addButton("Return", "eyebrowsMenu", nil)
    for i = 0, GetNumHairColors() do
        Menu.addButton("Eyebrow Color n°"..i, "eyebrowsColorSelectorMenuEnter", i, "eyebrowsColorSelectorMenu")
    end
    Menu.addButton("Return", "eyebrowsMenu", nil, nil)
end
...
function hairSelectorMenu()
    options.menu_subtitle = "Hair Style"
    ClearMenu()
    Menu.addButton("Return", "eyebrowsColorMenu", nil)
    for i = 0, GetNumberOfPedDrawableVariations(GetPlayerPed(-1), 2) -1 do
        Menu.addButton("Style n°"..i, "hairSelectorSwitcherEnter", i, "hairSelectorSwitcher")
    end
    Menu.addButton("Return", "eyebrowsColorMenu", nil)
end
...
function hairColorVariationSelectorMenu()
    options.menu_subtitle = "Hair Color"
    ClearMenu()
    Menu.addButton("Return", "hairSelectorMenu", nil)
    for i = 0,  GetNumHairColors() do

        Menu.addButton("Color n°"..i, "hairColorVariationSelectorSwitcherEnter", i, "hairColorVariationSelectorSwitcher")
    end
    Menu.addButton("Return", "hairSelectorMenu", nil)
end
...
function beardCutMenu()
    options.menu_subtitle = "Beard Style"
    ClearMenu()
    Menu.addButton("Return", "hairColorVariationSelectorMenu", nil)
    for i = 0, GetNumHeadOverlayValues(1) do
        Menu.addButton("Beard Style n°"..i, "beardSelectorCutMenuEnter", i, "beardSelectorCutMenu")
    end
    Menu.addButton("Return", "hairColorVariationSelectorMenu", nil)
end
function beardColorMenu()
    options.menu_subtitle = "Beard Color"
    ClearMenu()
    Menu.addButton("Return", "beardCutMenu", nil)
    for i = 0, GetNumHairColors() do
        Menu.addButton("Color n°"..i, "beardSelectorColorMenuEnter", i, "beardSelectorColorMenu")
    end
    Menu.addButton("Return", "beardCutMenu", nil)
end
...
function outfitMenu()
    options.menu_subtitle = "Outfit Selection"
    ClearMenu()
    Menu.addButton("Return", "hairColorVariationSelectorMenu", nil)
...
function saveMenu()
    ...
    freeze(false)
    Citizen.Trace(json.encode(current_skin))
