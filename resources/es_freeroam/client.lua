...
AddEventHandler('es_freeroam:spawnPlayer', function(x, y, z)
  ...
  AddEventHandler("playerSpawned", function(spawn)
    ...
    while true do
      ...
      AddTextComponentString("Welcome to the LostRP ~g~community~s~!\n ~y~For more information type /help");
      SetNotificationMessage("CHAR_ALL_PLAYERS_CONF", "CHAR_ALL_PLAYERS_CONF", true, 1, "Discord: ", "https://discord.gg/0oTUSAXQcxSbv84N");
      DrawNotification(false, true);
	  --TriggerEvent("chatMessage", 'INFO', { 0, 255, 255}, "Utilisez /help et /rules pour voir les commandes et infos serveur , Bon jeu.")
      TriggerEvent('chatMessage', 'INFO', {0,255,255}, "Type /help or /rules for more information about commands and the server.");
      Wait(10000000)
