...
TriggerEvent('es:addCommand', 'checkbalance', function(source, args, user)
  TriggerEvent('es:getPlayerFromId', source, function(user)
    ...
    local bankbalance = bankBalance(player)
    TriggerClientEvent("es_freeroam:notify", source, "CHAR_BANK_MAZE", 1, "Maze Bank", false, "Your current balance is: ~g~$".. bankbalance)
...
AddEventHandler('bank:deposit', function(amount)
  TriggerEvent('es:getPlayerFromId', source, function(user)
      ...
      if(string.len(rounded) >= 9) then
        TriggerClientEvent('chatMessage', source, "", {0, 0, 200}, "^1Specified value is too large.^0")
        CancelEvent()
      else
  ...
  TriggerEvent('es:getPlayerFromId', source, function(user)
      ...
      if(string.len(rounded) >= 9) then
        ...
        if(tonumber(rounded) <= tonumber(bankbalance)) then
          ...
          TriggerClientEvent('chatMessage', source, "", {0, 0, 200}, "^1You do not have enough money.^0")
          CancelEvent()
        end
      end
  end)
...
TriggerEvent('es:addCommand', 'transfer', function(source, args, user)
  ...
  if (args[2] ~= nil and tonumber(args[3]) > 0) then
    ...
    TriggerClientEvent('chatMessage', source, "", {0, 0, 200}, "^1Type /transfer [id] [amount]^0")
    return false
  end
end)
...
AddEventHandler('bank:transfer', function(fromPlayer, toPlayer, amount)
  ...
  if tonumber(fromPlayer) == tonumber(toPlayer) then
    TriggerClientEvent('chatMessage', source, "", {0, 0, 200}, "^1You cannot transfer money to yourself.^0")
    CancelEvent()
  else
...
TriggerEvent('es:addCommand', 'givecash', function(source, args, user)
  ...
  if (args[2] ~= nil and tonumber(args[3]) > 0) then
    ...
    TriggerClientEvent('chatMessage', source, "", {0, 0, 200}, "^1Type /givecash [id] [amount]^0")
    return false
  end
end)
...
TriggerEvent('es:addCommand', 'givedirty', function(source, args, user)
  ...
  if (args[2] ~= nil and tonumber(args[3]) > 0) then
    ...
    TriggerClientEvent('chatMessage', source, "", {0, 0, 200}, "^1Type /givedirty [id] [amount]^0")
    return false
  end
end)
	...
	TriggerEvent('es:getPlayerFromId', source, function(user)
		if (tonumber(user.money) >= tonumber(amount)) then
			...
			TriggerEvent('es:getPlayerFromId', toPlayer, function(recipient)
				...
				TriggerClientEvent("es_freeroam:notify", source, "CHAR_BANK_MAZE", 1, "Maze Bank", false, "Cash Given: ~r~-$".. amount .." ~n~~s~Wallet: ~g~$" .. user.money)
				TriggerClientEvent("es_freeroam:notify", toPlayer, "CHAR_BANK_MAZE", 1, "Maze Bank", false, "Cash Received: ~g~$".. amount .." ~n~~s~Wallet: ~g~$" .. recipient.money)
			end)
		else
			if (tonumber(user.money) < tonumber(amount)) then
        TriggerClientEvent('chatMessage', source, "", {0, 0, 200}, "^1You do not have enough money.^0")
	...
	TriggerEvent('es:getPlayerFromId', source, function(user)
		if (tonumber(user.dirty_money) >= tonumber(amount)) then
			...
			TriggerEvent('es:getPlayerFromId', toPlayer, function(recipient)
				...
				TriggerClientEvent("es_freeroam:notify", source, "CHAR_BANK_MAZE", 1, "Maze Bank", false, "Dirty Cash Given: ~r~-$".. amount .." ~n~~s~Wallet: ~g~$" .. user.dirty_money)
				TriggerClientEvent("es_freeroam:notify", toPlayer, "CHAR_BANK_MAZE", 1, "Maze Bank", false, "Dirty Cash Received: ~g~$".. amount .." ~n~~s~Wallet: ~g~$" .. recipient.dirty_money)
			end)
		else
			if (tonumber(user.dirty_money) < tonumber(amount)) then
        TriggerClientEvent('chatMessage', source, "", {0, 0, 200}, "^1You do not have enough money.^0")
